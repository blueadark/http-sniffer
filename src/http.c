 ...
 */
int 
http_parse_request(request_t *request, const char *data, const char *dataend,const char* body_data, const char* body_data_end){
	char *eoh, *eol, *linesp, *lineep;
	int line_cnt = 0, lnl = 0, hdl = 0;
        int bdl=0;
	eoh = find_header_end(data, dataend, &line_cnt);
	hdl = eoh - data + 1;
        bdl=body_data_end-body_data;
 ...
 */
int
http_parse_response(response_t *response, const char *data, const char *dataend,const char* body_data,const char *body_data_end)
{
	char *eoh, *eol, *linesp, *lineep;
