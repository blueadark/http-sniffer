...
int http_parse_request(request_t *request, const char *data, const char *dataend, const char *bodydata, const char *bodydataend);		/* Parse the packet and store in a request_t object */
int http_parse_response(response_t *response, const char *data, const char *dataend, const char *bodydata, const char *bodydataend);	/* Parse the packet and store in a response_t object */
