...
#define HTTP_RSP	0x10
	...
	char		*tcp_data;	/* Real useful http head data */
        char            *http_odata;    /* Orignal http body data */
        char            *http_data;     /* Real useful http body data */
        u_int16_t       http_dl;        /*Bytes:  http body length */
